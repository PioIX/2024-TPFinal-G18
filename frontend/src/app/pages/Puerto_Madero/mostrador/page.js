...
import styles from '@/app/pages/Puerto_Madero/mostrador/mostradormadero.module.css'; // Cambié styles por Styles para que coincida con la importación
...
export default function Game() {
  ...
  if (!soundRef.current) {
    soundRef.current = new Audio('/sound/La Yumba.mp3'); // Asegúrate de que la ruta sea correcta
  }
  ...
  useEffect(() => {
    ...
    useEffect(() => {
        ...
        socket.on("budinMostrador", (data) => {
            ...
            } if (data.budin === "chocolate") {
                setBudinURL(url + "budinChocolate.png");
            } if (data.budin === "frutilla") {
                setBudinURL(url + "budinFrutilla.png");
            } if (data.budin === "caramelo") {
                setBudinURL(url + "budinCaramelo.png");
            }
        });
    ...
    async function obtenerClientesMezcladosPorNivel() {
        try {
            const response = await fetch("http://localhost:4000/clientesPorEscenario?idEscenario=5", {
                method: "GET",
                headers: {
    ...
    const validarBudin = (tipoBudinCliente) => {
        ...
        if (tipoBudinCliente === "chocolate" && budinURL === "/objetos/budinChocolate.png") {
            ...
            return true;
        } else if (tipoBudinCliente === "frutilla" && budinURL === "/objetos/budinFrutilla.png") {
            console.log("Budín correcto: Frutilla");
            return true;
        } else if (tipoBudinCliente === "caramelo" && budinURL === "/objetos/budinCaramelo.png") {
            console.log("Budín correcto: Caramelo");
            return true;
        }
    ...
    return (
        <div className={styles.imgMadero}>
            <Score score={score} />
                ...
                <div className={styles.modalOverlay}>
                    <div className={styles.modalContent}> 
                        ...
                        <ul>
                            ...
                            <li>Budín de Frutilla: Budín + horno + frutilla</li>
                            <li>Budín de Caramelo: Budín + horno + caramelo</li>
                        </ul>
                        <h3>ALERTA!</h3>
                        <ul>
