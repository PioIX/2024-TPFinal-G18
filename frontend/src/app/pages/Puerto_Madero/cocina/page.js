...
import styles from "./cocinamadero.module.css";
...
export default function cocinaLogica() {
    ...
    const [isFrutillaSelected, setIsFrutillaSelected] = useState(false);
    const [isCarameloSelected, setIsCarameloSelected] = useState(false);
    ...
    const handleFrutillaClick = () => {
        if (!budinType) setIsFrutillaSelected(true);
    };

    const handleCarameloClick = () => {
        if (!budinType) setIsCarameloSelected(true);
    };
    ...
    const handleBudinCocidoClick = () => {
        ...
        if (isVainillaSelected) {
            ...
            setIsBudinFinalSelected(true); // Muestra la flecha
        } else if (isFrutillaSelected) {
            setBudinType("frutilla");
            setIsFrutillaSelected(false);
            setIsBudinFinalSelected(true); // Muestra la flecha
        } else if (isCarameloSelected) {
            setBudinType("caramelo");
            setIsCarameloSelected(false);
            setIsBudinFinalSelected(true); // Muestra la flecha
        }
    };
    ...
    return (
        ...
        <Score score={score} />
            ...
            {isCooked && (
                <img
                    src={
                        ...
                        : budinType === "frutilla"
                        ? "/objetos/budinFrutilla.png"
                        : budinType === "caramelo"
                        ? "/objetos/budinCaramelo.png"
            ...
            <img
                src="/objetos/frutilla.png"
                alt="Frutilla"
                className={styles.imgFrutilla}
                onClick={handleFrutillaClick}
            />

            <img
                src="/objetos/caramelo.png"
                alt="Caramelo"
                className={styles.imgCaramelo}
                onClick={handleCarameloClick}
            />
